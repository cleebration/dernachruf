...
const STYLES = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .masthead {
    background: #0e0c0a;
    border-bottom: 3px double #8a7a5a;
  ...
  .site-title {
    ...
    color: #d4c9b0;
    letter-spacing: 2px;
    text-shadow: 2px 2px 0 #3a3025, 4px 4px 12px rgba(0,0,0,0.9);
    line-height: 1;
  }
  .site-motto {
  ...
  .ornament { color: #5a4a2a; margin: 0 10px; }
  .edition-line {
    font-family: 'IM Fell English', serif;
    font-size: 10px;
    color: #3a2a1a;
  ...
  .nav-btn:hover { background: #0a0806; color: #c8a97e; }
  .nav-btn.active { background: #0a0806; color: #c8a97e; border-top: 2px solid #8a6a3a; }
  ...
  .filter-btn:hover { border-color: #6a5a3a; color: #c8a97e; }
  .filter-btn.active { background: #251e14; border-color: #8a6a3a; color: #c8a97e; }
  ...
  .post-card:hover { border-color: #5a4a2a; transform: translateY(-2px); box-shadow: 0 8px 30px rgba(0,0,0,0.6); }
  ...
  .cat-header:hover { background: #1e1a12; }
  ...
  .cat-item:hover { background: #1a1510; }
  .item-name {
    font-family: 'IM Fell English', serif;
    font-size: 14px;
    margin-bottom: 3px;
  ...
  .search-input::placeholder { color: #3a2a18; }
  .search-input:focus { border-color: #5a4a2a; }
  ...
  @media (max-width: 600px) {
    ...
    .nav-btn { font-size: 10px; padding: 10px 12px; }
  }
`;
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Georgia', serif", background: "#1a1714", minHeight: "100vh", color: "#c8b89a" }}>
      <style>{STYLES}</style>
      ...
      <div className="content">
        ...
        {view === "posts" && !activePost && (
          <>
            ...
            {filteredPosts.length === 0 && (
              <div style={{ textAlign: "center", fontFamily: "'IM Fell English', serif", fontStyle: "italic", color: "#4a3a22", padding: "60px 0" }}>
            ...
            <div style={{ textAlign: "center", fontFamily: "'IM Fell English', serif", fontStyle: "italic", color: "#3a2a18", fontSize: "13px" }}>
          ...
          return (
            <div className="post-full-wrap">
              ...
              <div style={{ marginTop: 36 }}>
                <div style={{ fontFamily: "'IM Fell English', serif", fontSize: "11px", letterSpacing: "3px", color: "#3a2a18", textTransform: "uppercase", marginBottom: 14 }}>
        ...
        {view === "archive" && (
          <>
            ...
            <div className="divider">· · · ✦ · · ·</div>
            <div style={{ textAlign: "center", fontFamily: "'IM Fell English', serif", fontStyle: "italic", color: "#3a2a18", fontSize: "12px" }}>
        ...
        {view === "about" && (
          <div style={{ maxWidth: 680, margin: "0 auto" }}>
            ...
            <div style={{ background: "#141008", border: "1px solid #1a1410", padding: "24px", fontFamily: "'IM Fell English', serif", marginBottom: 16 }}>
              <div style={{ fontSize: 11, letterSpacing: 3, color: "#3a2a18", textTransform: "uppercase", marginBottom: 16 }}>Kontakt</div>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <span style={{ color: "#4a3a22", fontSize: 18 }}>✉</span>
            ...
            <div style={{ background: "#141008", border: "1px solid #1a1410", padding: "24px", fontFamily: "'IM Fell English', serif" }}>
              <div style={{ fontSize: 11, letterSpacing: 3, color: "#3a2a18", textTransform: "uppercase", marginBottom: 12 }}>Das Archiv in Zahlen</div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: 16 }}>
                {[
                  ...
                  <div key={i} style={{ textAlign: "center" }}>
                    <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, fontWeight: 900, color: "#c8a97e" }}>{s.n}</div>
                    <div style={{ fontSize: 11, color: "#4a3a22", letterSpacing: 2, textTransform: "uppercase" }}>{s.label}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <footer style={{
        ...
        <div style={{ marginBottom: 16 }}>
          <a href="mailto:media@cleebration.com" style={{ color: "#5a4a2a", fontSize: 12, textDecoration: "none", letterSpacing: 1, fontStyle: "italic" }}>
            ✉ media@cleebration.com
          </a>
        </div>
        <div style={{ fontSize: 10, color: "#2a1a10", letterSpacing: 2, textTransform: "uppercase" }}>
